<%-- 
    Document   : index
    Created on : Nov 24, 2019, 9:31:12 PM
    Author     : hams
--%>
...
<html lang="en">
    <head>
        ...
        <link href="assets/vendors/line-icon/css/simple-line-icons.css" rel="stylesheet">
        ...
        <link href="assets/vendors/bootstrap-selector/css/bootstrap-select.min.css" rel="stylesheet">
                            ...
                            <div class="top_header_left">
                                <div class="selector">
                                    <select class="language_drop" name="countries" id="countries" style="width:300px;">
                                      <option value='yt' data-image="assets/img/icon/flag-1.png" data-imagecss="flag yt" data-title="English">English</option>
                                      <option value='yu' data-image="assets/img/icon/flag-1.png" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                                      <option value='yt' data-image="assets/img/icon/flag-1.png" data-imagecss="flag yt" data-title="English">English</option>
                                      <option value='yu' data-image="assets/img/icon/flag-1.png" data-imagecss="flag yu" data-title="Bangladesh">Bangla</option>
                                    </select>
                                </div>
