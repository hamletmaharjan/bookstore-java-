 ...
 * @author hams
 */
@WebServlet(name = "BookByCategoriesController", urlPatterns = {"/bookbycategories"})
public class BookByCategoriesController extends HttpServlet {
    ...
    private void dispatchRequest(HttpServletRequest request, HttpServletResponse response, String bookbycatURL) throws ServletException, IOException {
        String booklistURL = null;
        request.getRequestDispatcher(bookbycatURL).forward(request, response);
    }
