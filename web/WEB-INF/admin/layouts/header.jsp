<%-- 
    Document   : header
    Created on : Nov 29, 2019, 9:32:52 PM
    Author     : hams
--%>
...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="dashboard.php" class="logo">My<span class="lite"> Workspace</span></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="img/icons/admin.png" height="30px" width="30px">
                            </span>
